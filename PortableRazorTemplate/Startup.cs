...
using PortableRazor;
using PortableRazorTemplate.Controllers;

namespace PortableRazorTemplate
{
	public class Startup
	{
		...
		public static void Show () {
			var politicianController = RouteHandler.Controllers["Controller1"] as Controller1;
			politicianController.ShowRazorView();
		}
	}
}
